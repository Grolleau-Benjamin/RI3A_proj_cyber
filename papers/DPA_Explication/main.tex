...
Pour retrouver le byte de la clé, on teste les 256 possibilités présentes sur l’intervalle $guess \in [0x00; 0xff]$, pour chaque hypothèse \textit{guess}, et pour les 600 traces disponibles, on calcule :
